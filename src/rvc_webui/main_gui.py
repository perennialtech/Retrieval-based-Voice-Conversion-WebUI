...
def main():
    ...
    class GUI:
        ...
        def load(self):
            try:
                p = PROJECT_ROOT / "logs/userdata/configs/config.json"
                if not p.exists():
                ...
                with open(PROJECT_ROOT / "logs/userdata/configs/config.json", "w") as j:
                    data = {
                        "pth_path": "",
                        "index_path": "",
                        ...
                        layout=[
                            ...
                            [
                                ...
                                sg.FileBrowse(
                                    ...
                                    initial_folder=str(PROJECT_ROOT / "logs"),
            ...
            while True:
                ...
                if event == "start_vc" and not flag_vc:
                    if self.set_values(values) == True:
                        ...
                        with open(
                            PROJECT_ROOT / "logs/userdata/configs/config.json", "w"
                        ) as j:
