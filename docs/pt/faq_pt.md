...
- Agora você vai ver a opção `Carregue o caminho G do modelo base pré-treinado:` e `Carregue o caminho D do modelo base pré-treinado:`
  -Aqui você vai por o caminho dos modelos que estão em `./logs/minha-voz` - Vai ficar algo parecido com isso `e:/RVC/logs/minha-voz/G_0000.pth` e `e:/RVC/logs/minha-voz/D_0000.pth`
  -Coloque pra treinar
